...
from V18Music.modules.play import generate_cover
from V18Music.modules.play import arq
from V18Music.modules.play import cb_admin_check
from V18Music.modules.play import transcode
from V18Music.modules.play import convert_seconds
from V18Music.modules.play import time_to_seconds
from V18Music.modules.play import changeImageSize
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @V18Music to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
