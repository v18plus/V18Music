...
async def _(client, message):
    lel = await message.reply("🔎 **Grace Sedang Mencari lyrics**")
    query = message.text
    if not query:
        await lel.edit("**Grace lyrics Tidak ditemukan**")
        return
    ...
    if song:
        ...
        reply = "**lyrics Tidak ditemukan** coba cari dengan judul lagu yang lebih jelas (jangan di singkat-singkat) jika masih tidak berhasil coba `.glyrics`"
